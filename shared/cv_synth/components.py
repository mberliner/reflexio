...
BULLETS: dict[str, list[str]] = {
    "backend": [
        ...
        "Optimice el rendimiento a traves de la refactorizacion de codigo y la indexacion de {db}.",
    ...
    "devops": [
        ...
        "Colabore con equipos de desarrollo para asegurar la integracion fluida de aplicaciones.",
