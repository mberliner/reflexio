...
EXTRACTION_ROWS = [
    ("train",
     ...
     "Roberto Salinas", "roberto.salinas@uni.edu", "12",
     "Python, C++, CUDA", "Doctorado Ciencias Computacion, MIT"),
    ("train",
     ...
     "Maria Jose Rivero", "mjrivero@gmail.com", "8",
     "Roadmap, Scrum, Jira, Analisis de Datos", "Licenciatura Administracion, UBA"),
    ("train",
     "ing. Pablo Nunez\np.nunez@empresa.com.ar\n"
     "Desarrollador desde 2017.\nTecnologias: Java, Spring, MySQL, Docker.\n"
     "Ingenieria en Sistemas, UTN.",
     "Pablo Nunez", "p.nunez@empresa.com.ar", "8",
     "Java, Spring, MySQL, Docker", "Ingenieria Sistemas, UTN"),
    ("train",
     ...
     "Lucia Ferraro", "lucia.ferraro@mail.com", "5",
     "Figma, Sketch, Investigacion de usuarios, Prototipado", "Grado Diseno Grafico, RISD"),
    ("train",
     ...
     "Juan Perez", "juan.perez@email.com", "5",
     "Python, Machine Learning, Docker", "Maestria Ciencia Datos, Stanford"),
    ("train",
     ...
     "Sandra Gil", "sandra.gil@corp.io", "10",
    ...
    ("val",
     ...
     "Andrea Bianchi", "andrea.bianchi@consultora.com", "7",
     "Modelado Financiero, Excel, Valuacion, SQL", "MBA, IAE Business School"),
    ("val",
     "FERNANDO CASTRO\nfernando.castro@dev.io\n"
     "Trabajo en backend desde 2015 a la fecha.\n"
     "Skills: Python, Django, PostgreSQL, AWS.\n"
     "Ingenieria Informatica, Universidad de Chile.",
     "Fernando Castro", "fernando.castro@dev.io", "9",
     "Python, Django, PostgreSQL, AWS", "Ingenieria Informatica, Universidad Chile"),
    ("val",
     ...
     "Natalia Romero", "natalia.romero@outlook.com", "3",
     "Python, SQL, Power BI, Tableau, Estadistica",
    ...
    ("val",
     ...
     "Diego Morales", "diego.morales@empresa.mx", "6",
     "React, Node.js, MongoDB, TypeScript", "Ingenieria Tecnologias Informacion, Tec de Monterrey"),
    ("test",
     ...
     "Carmen Ortiz", "carmen.ortiz@hospital.org", "15",
    ...
    ("test",
     ...
     "Gaston Romero", "gaston.romero@gmail.com", "8",
     "PHP, Laravel, MySQL, JavaScript, Vue", "Tecnicatura Programacion, UTN"),
    ("test",
     ...
     "Valeria Sosa", "valeria.sosa@correo.com.uy", "7",
     "Negociacion de Contratos, Generacion de Leads, CRM, Salesforce",
    ...
    ("test",
     ...
     "Tomas Iglesias", "tomas.iglesias@startup.io", "5",
     "Docker, Kubernetes, Terraform, AWS, Bash",
    ...
    ("test",
     ...
     "Paula Mendez", "paula.mendez@mail.com", "6",
     "Selenium, Python, Postman, JIRA, Pruebas Automatizadas",
    ...
    ("test",
     ...
     "Ricardo Blanco", "ricardo.blanco@empresa.cl", "9",
     "Java, Kotlin, Spring, Kafka, Microservicios",
    ...
    ("test",
     ...
     "Florencia Diaz", "florencia.diaz@consultora.com.ar", "4",
    ...
    ("test",
     ...
     "Marcos Leon", "marcos.leon@webmail.com", "11",
     "Python, FastAPI, PostgreSQL, Redis, Docker, CI/CD",
    ...
    ("test",
     ...
     "Lorena Vega", "lorena.vega@correo.pe", "8",
     "PMP, Scrum, Kanban, MS Project, Liderazgo", "MBA, Universidad Pacifico"),
    ("test",
     ...
     "Sebastian Rey", "sebastian.rey@gmail.com", "7",
     "Spark, Python, Airflow, SQL, Snowflake, dbt", "Ingenieria Industrial, ITBA"),
    ("test",
     ...
     "Cecilia Paz", "cecilia.paz@empresa.com", "6",
     "Reclutamiento, Onboarding, Workday, Comunicacion Interna",
    ...
    ("test",
     ...
     "Martin Aceves", "martin.aceves@correo.mx", "12",
     "Swift, Objective-C, Kotlin, Firebase", "Ingenieria Software, Universidad Guadalajara"),
    ("test",
     ...
     "Alejandro Vidal", "alejandro.vidal@lab.edu", "20",
     "C, C++, Rust, Sistemas Embebidos, RTOS", "PhD Ingenieria Electronica, Caltech"),
    ...
    ("test",
     ...
     "Mateo Fuentes", "mateo.fuentes@empresa.com.ar", "9",
     "Angular, TypeScript, Node.js, Express, MongoDB, Docker",
    ...
    ("test",
     ...
     "Julieta Navarro", "julieta.navarro@correo.com", "4",
     "Adobe Illustrator, Photoshop, InDesign, Branding, Tipografia",
    ...
    ("test",
     ...
     "Ramiro Guzman", "ramiro.guzman@gmail.com", "13",
     "Oracle, PostgreSQL, MySQL, Linux, Bash, Ansible",
    ...
    ("test",
     ...
     "Beatriz Campos", "beatriz.campos@consultora.cl", "15",
    ...
    ("test",
     ...
     "Emiliano Prado", "emiliano.prado@startup.io", "8",
     "Python, PyTorch, TensorFlow, MLOps, Kubernetes",
    ...
    ("test",
     ...
     "Carla Espinoza", "carla.espinoza@correo.pe", "8",
     "Python, FastAPI, PostgreSQL, Redis, RabbitMQ",
    ...
    ("test",
     ...
     "Gonzalo Ledesma", "gonzalo.ledesma@empresa.com.mx", "6",
    ...
    ("val",
     ...
     "Adriana Molina", "adriana.molina@colegio.edu.ar", "14",
     "Didactica, Evaluacion, Moodle, Planificacion, Oratoria",
    ...
    ("val",
     ...
     "Ingenieria en Sistemas, Universidad Tecnologica Nacional.",
     "Bruno Iglesias", "bruno.iglesias@dev.com", "9",
     "Python, Django, FastAPI, PostgreSQL, Redis, Docker",
     "Ingenieria Sistemas, Universidad Tecnologica Nacional"),
    ("val",
     ...
     "Veronica Sosa", "veronica.sosa@estudio.com.ar", "11",
     "Impuestos, Balances, SAP, Excel, Conciliaciones",
    ...
    ("val",
     ...
     "Matias Paredes", "matias.paredes@constructora.cl", "14",
     "AutoCAD, Revit, Gestion de Obra, Presupuestos, MS Project",
    ...
    ("val",
     ...
     "Daniela Cruz", "daniela.cruz@traducciones.com", "8",
     "Ingles, Portugues, Frances, Trados, Subtitulado",
    ...
    ("val",
     ...
     "Federico Lara", "federico.lara@investigacion.org", "18",
...
def main() -> int:
    ...
    triage_rows = [
        [split, cv, JD, label, just, "no"] for (split, cv, label, just) in TRIAGE_ROWS
    ]
