...
TRIAGE = {
    ...
    "juan.perez@email.com": (
        "fit_medio",
        "Python+Docker+AWS, 5 anos. Falta FastAPI/Django/PostgreSQL explicito e idiomas declarados.",  # noqa: E501
    ),  # noqa: E501
    ...
    "elena.petrov@research.edu": (
        "no_fit",
        "Investigadora AI academica, no backend de produccion.",
    ),  # noqa: E501
    # === SINTETICOS CLAROS ===
    "martin.acosta@dev.com.ar": (
        "fit_alto",
        "Backend Python/FastAPI/PostgreSQL/Docker, 7 anos como Tech Lead, fintech, AR, ingles B2.",
    ),  # noqa: E501
    "lucia.fernandez@correo.mx": (
        "fit_alto",
        "Backend Senior Django, 6 anos, e-commerce MX, ingles C1. Stack completo.",
    ),  # noqa: E501
    "diego.ramirez@saas.co": (
        "fit_alto",
        "Python/FastAPI/PostgreSQL/Docker/K8s, 5 anos SaaS, CO, ingles B2.",
    ),  # noqa: E501
    "florencia.sosa@fintech.uy": (
        "fit_alto",
        "Tech Lead Backend, 8 anos en fintech UY, Django+FastAPI, ingles B2.",
    ),  # noqa: E501
    "andres.vargas@ecomm.cl": (
        "fit_alto",
        "Senior Backend Python/FastAPI/PostgreSQL/Docker, 6 anos e-commerce CL, ingles C1.",
    ),  # noqa: E501
    "pablo.gimenez@correo.com.ar": (
        "fit_medio",
        "Stack y seniority correctos, pero ingles A2 incumple el B2 excluyente.",
    ),  # noqa: E501
    "ines.mora@tech.es": (
        "fit_medio",
        "Perfil tecnico ideal pero reside en Espana, fuera de LATAM.",
    ),  # noqa: E501
    "tomas.herrera@dev.com.ar": (
        "fit_medio",
        "Stack alineado y LATAM, pero junior con solo 2 anos (la JD pide 4+).",
    ),  # noqa: E501
    "camila.torres@shop.mx": (
        "fit_medio",
        "Backend Python en LATAM, pero stack Flask en vez de FastAPI/Django y sin Docker.",
    ),  # noqa: E501
    ...
    "diego.salgado@dev.com.ar": (
        "fit_alto",
        "Backend Python/FastAPI/PostgreSQL/Docker/K8s, 8 anos como Tech Lead en fintech y SaaS, AR, ingles B2. Cumple todo.",  # noqa: E501
    ),  # noqa: E501
    "sofia.velez@tech.mx": (
        "fit_medio",
        "Stack alineado en MX con ingles B2, pero solo 3 anos pese a titulo Senior (la JD pide 4+).",  # noqa: E501
    ),  # noqa: E501
    "karina.mendel@research.io": (
        "no_fit",
        "Perfil de investigacion academica (deep learning), no backend de produccion. Ubicacion en Boston, fuera de LATAM.",  # noqa: E501
    ),  # noqa: E501
    "joaquin.aravena@dev.cl": (
        "fit_alto",
        "Backend Python (Django/FastAPI/PostgreSQL/Docker/K8s), 9 anos, fintech y SaaS, CL, ingles C1.",  # noqa: E501
    ),  # noqa: E501
    "daniela.kohler@frontend.com.ar": ("no_fit", "Perfil frontend (React/TS/Next), no backend."),
    "hernan.cabezas@dev.com": (
        "fit_medio",
        "Stack y seniority perfectos con ingles B2, pero ubicacion solo declara 'Latinoamerica' sin pais especifico.",  # noqa: E501
    ),  # noqa: E501
    "ricardo.tanaka@mobile.com": (
        "no_fit",
        "Desarrollador mobile (Kotlin/Swift), no backend. Ubicacion solo 'remoto' sin pais.",
    ),  # noqa: E501
    "valentina.aguirre@data.uy": (
        "no_fit",
        "Data engineer (Spark/Hadoop/Airflow) en retail, no backend de APIs.",
    ),  # noqa: E501
    "r.espinoza@dev.pe": (
        "no_fit",
        "Stack PHP/Laravel, no Python. Ademas ingles B1 incumple el B2 excluyente.",
    ),  # noqa: E501
    "mauricio.esposito@correo.com.ar": (
        "fit_alto",
        "Backend Python/FastAPI/PostgreSQL/Docker/AWS, 6 anos, fintech, AR, ingles B2.",
    ),  # noqa: E501
    "lukas.mueller@design.de": (
        "no_fit",
        "Perfil UX/UI designer, no backend. Aleman nativo (no espanol).",
    ),  # noqa: E501
    "constanza.rivas@correo.com.ar": (
        "fit_medio",
        "Stack ideal y ubicacion AR, pero ingles B1 incumple el B2 excluyente.",
    ),  # noqa: E501
}
