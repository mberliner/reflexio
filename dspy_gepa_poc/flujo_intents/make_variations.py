...
# ===========================================================================
# TRIAGE_SOLIDEZ: solido / devolucion_reformulacion / devolucion_no_ia
...
SOLIDEZ = [
    ...
    # devolucion_no_ia (10 train + 5 val): BPM/digitalizacion/reglas fijas sin inferencia
    _sol(
        "VAR-SOL-N01",
        "operativo",
        ["operativos"],
        "devolucion_no_ia",
        "train",
        "Digitalizar el formulario de solicitud de licencias en el portal de RRHH y eliminar pasos manuales.",
        area="RRHH",
    ),
    _sol(
        "VAR-SOL-N02",
        ...
        "devolucion_no_ia",
        "train",
        "Automatizar la conciliacion bancaria con reglas fijas que cruzan movimientos contra el ERP.",
        area="Finanzas",
    ),
    _sol(
        "VAR-SOL-N03",
        ...
        "devolucion_no_ia",
        "train",
        "Rediseñar el flujo de aprobacion de compras eliminando aprobaciones redundantes.",
        area="Compras",
    ),
    _sol(
        "VAR-SOL-N04",
        ...
        "devolucion_no_ia",
        "train",
        "Migrar las planillas de control de horas a un sistema web con validaciones de campos.",
        area="Administracion",
    ),
    _sol(
        "VAR-SOL-N05",
        ...
        "devolucion_no_ia",
        "train",
        "Implementar reglas de negocio fijas para calcular descuentos segun una tabla predefinida.",
        area="Comercial",
    ),
    _sol(
        "VAR-SOL-N06",
        ...
        "devolucion_no_ia",
        "train",
        "Digitalizar el archivo de expedientes en un gestor documental con busqueda por metadatos.",
        area="Legal",
    ),
    _sol(
        "VAR-SOL-N07",
        ...
        "devolucion_no_ia",
        "train",
        "Crear un tablero de BI con indicadores predefinidos a partir de consultas SQL fijas.",
        area="Planificacion",
    ),
    _sol(
        "VAR-SOL-N08",
        ...
        "devolucion_no_ia",
        "train",
        "Automatizar el envio de recordatorios por correo segun fechas de vencimiento en una agenda.",
        area="Cobranzas",
    ),
    _sol(
        "VAR-SOL-N09",
        ...
        "devolucion_no_ia",
        "train",
        "Implementar un workflow de aprobaciones con pasos fijos y notificaciones automaticas.",
        area="Operaciones",
    ),
    _sol(
        "VAR-SOL-N10",
        ...
        "devolucion_no_ia",
        "train",
        "Migrar la base de datos on-premise a la nube sin cambios funcionales.",
        area="Plataforma",
    ),
    _sol(
        "VAR-SOL-N11",
        ...
        "devolucion_no_ia",
        "val",
        "Digitalizar el alta de proveedores con un formulario y validaciones de formato.",
        area="Compras",
    ),
    _sol(
        "VAR-SOL-N12",
        ...
        "devolucion_no_ia",
        "val",
        "Automatizar el calculo de comisiones con una formula fija sobre las ventas registradas.",
        area="Comercial",
    ),
    _sol(
        "VAR-SOL-N13",
        ...
        "devolucion_no_ia",
        "val",
        "Reemplazar el control manual de stock por lectura de codigos de barras.",
        area="Logistica",
    ),
    _sol(
        "VAR-SOL-N14",
        ...
        "devolucion_no_ia",
        "val",
        "Crear un portal de autogestion para que el empleado descargue sus recibos.",
        area="RRHH",
    ),
    _sol(
        "VAR-SOL-N15",
        ...
        "devolucion_no_ia",
        "val",
        "Integrar dos sistemas via API para sincronizar catalogos con reglas fijas de mapeo.",
        area="Plataforma",
    ),
]
...
# ===========================================================================
# TRIAGE_FACTIBILIDAD: avanza_fast_gate / avanza_con_redisenio / no_avanza / rechazo_formal
# ===========================================================================
...
FACTIBILIDAD = [
    ...
    # rechazo_formal (7 train + 3 val): §9.2 uso prohibido / §7.4 duplicado
    _fac(
        "VAR-FAC-R01",
        "negocio",
        ["personales"],
        "rechazo_formal",
        "train",
        "Sistema que decide el acceso a un plan usando genero, edad y nacionalidad como variables de scoring.",
        impacto="Clientes solicitantes. Criticidad muy alta.",
        restr="Prohibido usar atributos protegidos en decisiones de acceso.",
    ),
    _fac(
        "VAR-FAC-R02",
        "operativo",
        ...
        "rechazo_formal",
        "train",
        "Sistema que prioriza candidatos usando genero y edad en decisiones de contratacion.",
        impacto="Candidatos. Criticidad alta.",
        restr="Prohibido el sesgo por atributos protegidos en el empleo.",
    ),
    _fac(
        "VAR-FAC-R03",
        "negocio",
        ...
        "rechazo_formal",
        "train",
        "Sistema que ajusta primas de seguro segun el codigo postal y la nacionalidad del solicitante.",
        impacto="Clientes. Criticidad alta.",
        restr="Prohibida la discriminacion por origen o residencia.",
    ),
    _fac(
        "VAR-FAC-R04",
        "operativo",
        ...
        "rechazo_formal",
        "train",
        "Sistema que filtra el acceso a beneficios usando religion o afiliacion como variable.",
        impacto="Empleados. Criticidad alta.",
        restr="Prohibido el uso de atributos protegidos.",
    ),
    _fac(
        "VAR-FAC-R05",
        "capacidad",
        ...
        "rechazo_formal",
        "train",
        "Asistente de redaccion de comunicados internos identico a un caso Verde ya pre-clasificado en el catalogo N2.",
        riesgo="Mismo sistema, datos y modelo que el caso pre-clasificado.",
        restr="Existe alternativa aprobada equivalente (§7.4).",
    ),
    _fac(
        "VAR-FAC-R06",
        "capacidad",
        ...
        "rechazo_formal",
        "train",
        "Asistente de resumen de actas funcionalmente identico a una herramienta ya aprobada en el catalogo.",
        riesgo="Duplicado de un caso aprobado.",
        restr="Existe alternativa aprobada equivalente (§7.4).",
    ),
    _fac(
        "VAR-FAC-R07",
        ...
        "rechazo_formal",
        "train",
        "Sistema que niega servicio segun el barrio de residencia del solicitante.",
        impacto="Clientes. Criticidad alta.",
        restr="Prohibida la discriminacion por residencia.",
    ),
    _fac(
        "VAR-FAC-R08",
        "negocio",
        ...
        "rechazo_formal",
        "val",
        "Motor que aprueba creditos usando genero y nacionalidad como predictores.",
        impacto="Clientes. Criticidad muy alta.",
        restr="Prohibidos los atributos protegidos en decisiones de acceso.",
    ),
    _fac(
        "VAR-FAC-R09",
        "operativo",
        ...
        "rechazo_formal",
        "val",
        "Sistema que asigna turnos de atencion priorizando por etnia declarada.",
        impacto="Clientes. Criticidad alta.",
        restr="Prohibida la discriminacion por origen etnico.",
    ),
    _fac(
        "VAR-FAC-R10",
        "capacidad",
        ...
        "rechazo_formal",
        "val",
        "Asistente de generacion de contenido interno identico a uno ya aprobado en el catalogo N2.",
        riesgo="Duplicado de un caso pre-clasificado.",
        restr="Existe alternativa aprobada equivalente (§7.4).",
    ),
]
