...
echo "  Comando:"
echo ""
echo -e "${BOLD}    python -m gepa_standalone.universal_optimizer --config gepa_standalone/experiments/configs/email_urgency.yaml${RESET}"
echo -e "    (desde la raiz del repo; -m es necesario para que 'import shared' resuelva)"
echo ""
